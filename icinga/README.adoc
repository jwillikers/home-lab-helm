...
[,sh]
----
for host_template in ~/Projects/icinga-config/etc/icinga2/constants.d/*.conf.template; do cp -- "$host_template" ~/Projects/icinga-config/etc/icinga2/constants.d/$(basename -- "$host_template" ".template"); done
----
...
[,sh]
----
for host_template in ~/Projects/icinga-config/etc/icinga2/constants.d/*.conf.template; cp -- "$host_template" ~/Projects/icinga-config/etc/icinga2/constants.d/(basename -- "$host_template" ".template"); end
----
...
[,sh]
----
for host_template in (glob ~/Projects/icinga-config/etc/icinga2/constants.d/*.conf.template) { cp $host_template $"($host_template | path parse | reject extension | path join)" }
----
...
[,sh]
----
cp icingadb-secrets.yaml.template icingadb-secrets.yaml
----
...
[,sh]
----
cp icingaweb-secrets.yaml.template icingaweb-secrets.yaml
----
